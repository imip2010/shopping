                            ...
                            <div class="card-body">
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active"> <img class="img-slide" src="<?php echo base_url()?>assets/images/background/weatherbg.jpg" alt="First slide"> </div>
                                        <div class="carousel-item"> <img class="img-slide" src="<?php echo base_url()?>assets/images/big/img5.jpg" alt="Second slide"> </div>
                                        <div class="carousel-item"> <img class="img-slide" src="<?php echo base_url()?>assets/images/big/img6.jpg" alt="Third slide"> </div>
                                    </div>
