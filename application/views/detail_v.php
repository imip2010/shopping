            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-4">
                        <div class="white-box text-center"> <img src="<?php echo base_url()?>assets/images/gallery/chair.jpg" class="img-responsive" style="width: 125%;"> </div>
                    </div>
                    <div class="col-lg-9 col-md-9 col-sm-6">
                        <h4 class="box-title m-t-40">Deskripsi Produk</h4>
            ...
            <div class="card-body">
                ...
                <div class="d-flex no-block align-items-center p-15  m-b-10">
                    ...
                    <div class="m-l-10">
                        ...
                        <a href="#"><p><i class="ti-location-pin font-20"></i>Jakarta Selatan</p></a>
                    </div>
                </div>
