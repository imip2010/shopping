            ...
            <div class="card"><br>
                    ...
                    <div class="row">
                        <div class="process">
                            <div class="process-row nav nav-tabs">
                                ...
                                <div class="process-step">
                                    <button type="button" class="btn btn-default btn-bulat"  ><i class="fa fa-truck fa-3x"></i></button>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <button type="button" class="btn waves-effect waves-light btn-info" style="width: 100%;"> Hubungi Penjual </button><br>
                            <button type="button" class="btn waves-effect waves-light btn-outline-info" style="margin-top: 10px; width: 100%;"> Batalkan Pesanan </button><br>
                            <button type="button" class="btn waves-effect waves-light btn-outline-info" style="margin-top: 10px; margin-bottom: 10px; width: 100%;"> Perpanjang Masa Garansi Toko </button><br>
                        </div>
                    </div>
                </div>
            </div>
